...
def read(cookies):
    ...
    headers = {
        ...
        'user-agent': 'Mozilla/5.0 (Linux; Android 10; EML-AL00; HMSCore 5.1.1.303; GMSCore 20.15.16) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 HuaweiBrowser/11.0.7.303 Mobile Safari/537.36',
